...
function StepChart() {
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
      ...
      <p className="text-sm text-slate-500 mb-6">Al giorno 7 (Kyoto piena) tocchiamo i 30.000 passi. Portiamoci scarpe serie o piangiamo al terzo tempio.</p>
      ...
      <header className="py-16 px-4 bg-white border-b border-slate-200 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium" data-testid="text-stats-subtitle">
            Per non crepare a met&agrave; viaggio abbiamo fatto i conti. 14 giorni, 7 tappe, un milione di passi. Chi molla paga da bere a tutti.
          </p>
        </div>
      </header>
