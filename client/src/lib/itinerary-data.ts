...
export const itineraryData: DayData[] = [
  {
    day: 1, date: "19 Mar", title: "Primo impatto: Shibuya + Shinjuku Night", location: "Tokyo", tag: "Impatto", icon: "\u{1F3D9}\uFE0F",
    timeline: [
      { time: "11:00", title: "Arrivo e setup",
        detail: "Atterrati. IC Card Suica su Apple Wallet, prelievo yen al 7-Eleven, primo konbini pit stop. Check-in al Ginza Creston e via verso la città.",
      ...
      { time: "17:00", title: "Shibuya Crossing — L'incrocio più famoso del mondo",
        detail: "<b>Shibuya Crossing</b> — Fino a 3,000 persone lo attraversano a ogni semaforo verde. Attraversato l'incrocio, giro nel quartiere, statua di Hachiko. Primo impatto con l'energia di Tokyo al livello strada.",
      ...
      { time: "20:00", title: "Shinjuku — Sushi al nastro e prima sera",
        detail: "Spostamento a Shinjuku per la prima sera vera a Tokyo. Cena al <b>kaiten-zushi</b> (sushi al nastro trasportatore) — il modo più divertente di mangiare sushi: i piatti girano sul nastro, prendiamo quello che ci ispira. Colori diversi = prezzi diversi. Primo contatto con la cucina giapponese vera.",
        maps: "https://maps.app.goo.gl/QgztVtSP3qzJkzHL6",
        image: "/itinerary/tokyo-night-bars.svg" }
    ]
  },
  {
    day: 2, date: "20 Mar", title: "Ueno + Yanaka + Asakusa — Tokyo tradizionale", location: "Tokyo", tag: "Tradizione", icon: "\u26E9\uFE0F",
    timeline: [
      { time: "08:30", title: "Ueno Park — Primi sakura e respiro verde",
        detail: "Mattina tranquilla nel parco più grande di Tokyo. <b>Ueno Park</b> è uno dei migliori spot per i sakura a fine marzo — centinaia di ciliegi lungo i viali. Passeggiata senza fretta, godiamoci il verde e l'atmosfera giapponese del mattino.<br><br><b>Cosa vedere:</b><br>• Il viale principale dei ciliegi — se siamo fortunati i primi fiori stanno aprendo<br>• <b>Shinobazu Pond</b> — lago con fiori di loto e il tempietto Benzaiten al centro<br>• Saltiamo i musei (servono ore) — il parco stesso è l'esperienza<br><br><b>Tempo:</b> ~2 ore | <b>Budget:</b> gratis",
        maps: "https://www.google.com/maps/search/?api=1&query=Ueno+Park+Tokyo",
        image: "https://images.unsplash.com/photo-1522383225653-ed111181a951?w=800&h=400&fit=crop" },
      { time: "10:45", title: "Yanaka — La Tokyo retrò che non ti aspetti",
        detail: "A 10 minuti a piedi da Ueno, entriamo nel quartiere più nostalgico di Tokyo. <b>Yanaka</b> è sopravvissuto ai bombardamenti e al boom economico — stradine strette, case in legno, gatti ovunque, zero turismo di massa.<br><br><b>Yanaka Ginza</b> — la via commerciale retrò (~170m). Street food locale: <i>menchi-katsu</i> (crocchetta di carne, ~250 yen), <i>yakitori</i> fresco, <i>senbei</i> (cracker di riso) grandi come una faccia.<br><br>Camminiamo senza meta nei vicoli laterali. Piccoli templi nascosti, cimitero storico di Yanaka con vista sulla Skytree, botteghe artigianali. Questo è il Giappone quotidiano, non quello da cartolina.<br><br><b>Pranzo qui:</b> sediamoci in una delle trattorie locali. ~1,000-1,500 yen.<br><b>Tempo:</b> ~2.5 ore",
        maps: "https://www.google.com/maps/search/?api=1&query=Yanaka+Ginza+Tokyo",
        image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800&h=400&fit=crop" },
      { time: "14:30", title: "Asakusa — Senso-ji e l'atmosfera del quartiere",
        detail: "Da Yanaka scendiamo verso Asakusa (~20 min in metro). <b>Senso-ji</b>, il tempio più antico di Tokyo (anno 645).<br><br><b>Come viverla:</b><br>1. Entriamo dal <b>Kaminarimon Gate</b> — la porta rossa gigante con la lanterna. Foto obbligatoria.<br>2. Percorriamo <b>Nakamise Street</b> (~250m di bancarelle). Prendiamo: <i>Ningyo-yaki</i> (dolcetti ripieni di anko, ~300 yen) e <i>Age-manju</i> (manju fritto, ~100 yen).<br>3. Al tempio: ci laviamo le mani alla <b>fontana rituale</b> (chozuya). Mano sinistra prima, poi destra, poi sciacquiamo la bocca.<br>4. Accendiamo un bastoncino d'incenso (~100 yen) — porta fortuna.<br>5. <b>Dietro il tempio</b>: meno folla, giardino <b>Demboin</b> spesso poco visitato.<br><br><b>Tempo:</b> ~2 ore | <b>Budget:</b> ~500 yen a testa",
      ...
      { time: "17:00", title: "Passeggiata Sumida River",
        detail: "Usciamo da Senso-ji e camminiamo lungo il fiume Sumida verso sud. Lo skyline con la <b>Tokyo Skytree</b> che domina tutto. Questa passeggiata serve per smaltire la giornata camminando, fare foto incredibili con la luce del tardo pomeriggio e sentire il ritmo della città.<br><br><b>Pro tip:</b> Attraversiamo il <b>Sumida Park</b> — a fine marzo potremmo trovare i primi sakura lungo il fiume.",
        maps: "https://www.google.com/maps/search/?api=1&query=Sumida+River+Walk",
        image: "/itinerary/tokyo-river-night.svg" },
      { time: "20:00", title: "Omoide Yokocho + Golden Gai — La sera vera",
        detail: "<b>Omoide Yokocho (Memory Lane / Piss Alley)</b> — Un labirinto di micro-ristoranti all'aperto, ciascuno con 6-8 posti, fumo alla griglia, lanterne rosse. È il Giappone crudo, autentico, da film.<br><br>Ci sediamo in uno con lo <i>yakitori</i>. Ordiniamo: <i>negima</i> (pollo e cipollotto), <i>tsukune</i> (polpetta), <i>kawa</i> (pelle croccante), <i>sunagimo</i> (ventriglio — fidiamoci). 4-5 spiedini a testa (~150-200 yen l'uno) + <i>nama biiru</i> (birra alla spina, ~500 yen). Budget per 3: ~5,000-7,000 yen totali.<br><br><b>Golden Gai</b> — 200+ micro-bar in 6 vicoli stretti. Ogni bar ha 5-10 posti. Portiamo <b>solo cash</b>. Cover charge 500-1,000 yen (è normale). Entriamo in almeno <b>2-3 bar diversi</b>. Bar consigliati: <i>Ace's</i> (prezzi bassi), <i>Black Sun</i> (jazz), <i>Albatross</i> (su 3 piani, atmosfera unica).<br><b>Budget:</b> ~3,000-5,000 yen a testa.",
        maps: "https://maps.app.goo.gl/QgztVtSP3qzJkzHL6",
        image: "/itinerary/tokyo-night-bars.svg" }
    ]
  },
  {
    day: 3, date: "21 Mar", title: "Tsukiji + teamLab Borderless + Bar BenFiddich", location: "Tokyo", tag: "Futuro & Cocktail", icon: "\u{1F52E}",
    timeline: [
      { time: "09:00", title: "Tsukiji Outer Market — Colazione da re",
        detail: "A due passi dal Ginza Creston. Il mercato esterno è ancora attivo e la mattina è il momento migliore.<br><br><b>Cosa mangiare:</b><br>• <i>Sashimi freschissimo</i> sui banchi — tonno, salmone, <i>uni</i> (riccio di mare)<br>• <i>Tamago-yaki</i> (frittata dolce su stecco, ~300 yen) — il banco più famoso ha sempre la fila<br>• <i>Gyudon</i> (ciotola di riso e manzo) da uno dei chioschi<br>• <i>Tako tamago</i> — polpo intero piccolo con uovo di quaglia, su stecco (~400 yen)<br><br><b>Tempo:</b> ~2 ore | <b>Budget:</b> ~2,000 yen",
      ...
      { time: "11:15", title: "Passeggiata Ginza — Il quartiere elegante",
        detail: "Siamo in zona, godiamocela con calma. <b>Ginza</b> è il quartiere più elegante di Tokyo — architettura contemporanea, boutique, gallerie d'arte.<br><br><b>Cosa vedere:</b><br>• <b>Ginza Six</b> — centro commerciale con installazioni d'arte e rooftop garden gratuito<br>• <b>Itoya</b> — 12 piani di cartoleria giapponese. Quaderni, penne, carta washi. Souvenir perfetti<br>• Le strade laterali — gallerie d'arte gratuite e caffè nascosti<br><br>Pausa pranzo leggero prima di teamLab.",
        maps: "https://www.google.com/maps/search/?api=1&query=Ginza+Tokyo",
        image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=800&h=400&fit=crop" },
      { time: "14:00", title: "teamLab Borderless — Perdersi nell'arte digitale",
        detail: "Il museo digitale più famoso al mondo, ora ad <b>Azabudai Hills</b>. Non c'è percorso, non c'è mappa — per scelta. Le opere si spostano da una stanza all'altra. Noi vaghiamo e scopriamo.<br><br><b>Come arrivarci:</b> 2 minuti a piedi dall'uscita 5 di <b>Kamiyacho Station</b> (Hibiya Line, diretta dal Ginza Creston).<br><br><b>Regole:</b> Non c'è re-entry. Foto e video ok, no flash/tripod. Locker gratuiti — portiamo solo il telefono. Scarpe comode.<br><br><b>Tempo:</b> 2-3 ore | <b>Biglietto:</b> ~3,800 yen (prenotazione obbligatoria)",
  ...
  {
    day: 4, date: "22 Mar", title: "Meiji Jingu + Harajuku + Nakameguro + Ebisu", location: "Tokyo", tag: "Ovest & Sakura", icon: "\u{1F338}",
    timeline: [
      ...
      { time: "16:30", title: "Nakameguro — Sakura sul Meguro River",
        detail: "Questa è l'ora giusta: il <b>Meguro River</b> dà il meglio nel tardo pomeriggio e con le <b>illuminazioni serali dei ciliegi</b>. A fine marzo i sakura lungo il canale sono tra i più belli di tutta Tokyo.<br><br>~800 ciliegi su entrambe le sponde del fiume per quasi 4 km. Camminiamo lentamente, facciamo foto con la luce dorata. I petali che cadono sull'acqua sono ipnotici.<br><br><b>Il quartiere:</b> Nakameguro è anche una delle zone più cool di Tokyo — caffè di design, librerie indipendenti, negozi curati. Perfetto per una passeggiata pre-cena.<br><br><b>Budget:</b> gratis | <b>Tempo:</b> ~2 ore",
        maps: "https://www.google.com/maps/search/?api=1&query=Nakameguro+Meguro+River+Cherry+Blossom",
        image: "https://images.unsplash.com/photo-1522383225653-ed111181a951?w=800&h=400&fit=crop" },
      { time: "19:00", title: "Ebisu — Cena e serata da adulti",
        detail: "A una fermata da Nakameguro. <b>Ebisu</b> è il quartiere perfetto per chiudere la giornata: elegante, rilassato, più adulto di Shibuya.<br><br><b>Dove cenare:</b><br>• <i>Izakaya</i> nei vicoli dietro la stazione — cerchiamo quelli con le lanterne rosse e il fumo alla griglia<br>• <i>Ebisu Yokocho</i> — piccolo food court coperto con banconi diversi, atmosfera vivace<br>• <i>Afuri Ramen</i> (Ebisu) — ramen yuzu shio leggendario, ~1,100 yen<br><br><b>Dopo cena:</b> Passeggiata nel <b>Yebisu Garden Place</b> illuminato. Oppure un cocktail al <b>Bar Trench</b> o <b>Bar Tram</b> — due speakeasy eccellenti nella stessa strada.<br><b>Budget cena + drink:</b> ~5,000-8,000 yen a testa",
        maps: "https://www.google.com/maps/search/?api=1&query=Ebisu+Tokyo",
  ...
  },
  {
    ...
    timeline: [
      { time: "10:00", title: "Akihabara — La Capitale Nerd",
