...
export const itineraryData: DayData[] = [
  ...
  {
    day: 2, date: "20 Mar", title: "Meiji Jingu + Harajuku + Nakameguro + Ebisu", location: "Tokyo", tag: "Ovest & Sakura", icon: "\u{1F338}",
    timeline: [
  ...
  {
    day: 4, date: "22 Mar", title: "Ueno + Yanaka + Asakusa — Tokyo tradizionale", location: "Tokyo", tag: "Tradizione", icon: "\u26E9\uFE0F",
    timeline: [
